...
class Crowd_human:
    ...
    root_folder = '/crowddet/data'
    image_folder = '/crowddet/data/images'
    train_source = os.path.join('/crowddet/data/annotation_train.odgt')
    eval_source = os.path.join('/crowddet/data/annotation_val.odgt')
